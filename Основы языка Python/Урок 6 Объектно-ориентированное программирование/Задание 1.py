...
"""
"""
Если что-то не так в логике, не совсем понял задание может быть, не хватило конкретной информации. По цветам пока 
текст реализован, в turtle нужно сидеть разбираться ))) чтобы светофор сделать, может можно как-то по-другому, 
пока не в курсе ))
"""
...
while True:
    for i in range(len(lights)):
        if lights[i - 1] == 'red' or lights[i - 1] == 'yellow' or lights[i - 1] == 'green' and i != 'yellow':
            # так понял проверку режимов, или режим кто-то должен вводить?
